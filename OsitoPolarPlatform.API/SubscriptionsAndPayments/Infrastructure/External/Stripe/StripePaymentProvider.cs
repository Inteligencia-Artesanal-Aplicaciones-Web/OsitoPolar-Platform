...
using Stripe;
using StripeConfig = OsitoPolarPlatform.API.SubscriptionsAndPayments.Infrastructure.External.Stripe.StripeConfiguration;

namespace OsitoPolarPlatform.API.SubscriptionsAndPayments.Infrastructure.External.Stripe;
